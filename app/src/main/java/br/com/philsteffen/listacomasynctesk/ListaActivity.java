package br.com.philsteffen.listacomasynctesk;
...
import br.com.philsteffen.listacomasynctesk.adapter.AndroidAdapter;
...
public class ListaActivity extends AppCompatActivity {
    ...
    private void setUpRecyclerView(List<AndroID> data) {
        ...
        mAdapter.setClickListener(new OnItemClick() {
            @Override
